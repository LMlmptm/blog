# Generated by Django 2.2.8 on 2020-03-20 13:42
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('body', tinymce.models.HTMLField(verbose_name='博客正文')),
                ...
                ('tag', models.ManyToManyField(to='blog.Tag', verbose_name='博客标签')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='博客作者')),
            ],
            options={
                'verbose_name': '博客',
